...
- [RESTful APIs - Let your apps talk to each other](https://speakerdeck.com/devsdmf/restful-apis-let-your-apps-talk-to-each-other) - RESTful APIs talk presented at the "Escola de Férias" program in the Pontifical Catholic University of MInas Gerais.
